...
/**
 * A {@code Binding<UserAgentProvider>} implementation which satisfies
...
public final class UserAgentProvider$$InjectAdapter extends Binding<UserAgentProvider>
  ...
  public UserAgentProvider$$InjectAdapter() {
    super("com.sjtu.icarer.core.app.UserAgentProvider", "members/com.sjtu.icarer.core.app.UserAgentProvider", NOT_SINGLETON, UserAgentProvider.class);
  }
  ...
  public void attach(Linker linker) {
    appInfo = (Binding<android.content.pm.ApplicationInfo>) linker.requestBinding("android.content.pm.ApplicationInfo", UserAgentProvider.class, getClass().getClassLoader());
    classLoader = (Binding<ClassLoader>) linker.requestBinding("java.lang.ClassLoader", UserAgentProvider.class, getClass().getClassLoader());
    info = (Binding<android.content.pm.PackageInfo>) linker.requestBinding("android.content.pm.PackageInfo", UserAgentProvider.class, getClass().getClassLoader());
    telephonyManager = (Binding<android.telephony.TelephonyManager>) linker.requestBinding("android.telephony.TelephonyManager", UserAgentProvider.class, getClass().getClassLoader());
  }
