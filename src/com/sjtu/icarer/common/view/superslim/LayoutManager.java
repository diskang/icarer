package com.sjtu.icarer.common.view.superslim;
...
public class LayoutManager extends RecyclerView.LayoutManager {
    ...
    public LayoutManager(Context context) {
        ...
        mSlms = new HashMap<String, SectionLayoutManager>();
    }
...
//            attachView(header, findLastIndexForSection(sd.firstPosition) + 1);
	...
	private float getFractionOfContentAbove(RecyclerView.State state, boolean ignorePosition) {
        ...
        int firstPosition = -1;
        SparseArray<Boolean> positionsOffscreen = new SparseArray<Boolean>();
    ...
    public static class Builder {
        ...
        HashMap<String, SectionLayoutManager> slms = new HashMap<String, SectionLayoutManager>();
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        private class MissingFirstPositionException extends RuntimeException {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -6227523028241217062L;
        ...
        private class InvalidFirstPositionException extends RuntimeException {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -1208608477388513600L;
    ...
    private class NotYetImplementedSlmException extends RuntimeException {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 4504407662660958729L;
    ...
    private class UnknownSectionLayoutException extends RuntimeException {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7605933898234090227L;
