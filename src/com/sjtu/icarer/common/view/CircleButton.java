...
//		setClickable(true);
		...
		if (attrs != null) {
			...
			buttonOffColor= a.getColor(R.styleable.CircleButton_cb_color_off, buttonOffColor);
			buttonOnColor = a.getColor(R.styleable.CircleButton_cb_color, buttonOnColor);
			pressedRingWidth = (int) a.getDimension(R.styleable.CircleButton_cb_pressedRingWidth, pressedRingWidth);
			a.recycle();
		}

		setColor(buttonOffColor);
