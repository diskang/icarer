...
//		building_lp.setOnPreferenceClickListener(this); 
		...
		if(GERO_ID!=null&&!GERO_ID.isEmpty()){
			//��̬����ListPreference,������oncreate��ʵ�֣���onclickʱ��ʵ�ֻᰴ��ԭ����array����䣬�ڶ���onclick����Ч
	           inflateCarerList();
	           inflateRoomBegin();
		}
	...
	private void inflateRoomBegin(){
		...
		if (longRoomNumber!=null&&!longRoomNumber.isEmpty()){
			...
			if(slice.length==3){
				...
				FLOOR_NO = slice[1];
				ROOM_NO = slice[2];
				building_lp.setSummary("¥����: "+BUILDING_NO);
				floor_lp.setSummary("¥���: "+FLOOR_NO);
				room_lp.setSummary("�����: "+ROOM_NO);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
	    if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
	    	if(preferenceFinished()){
				...
				.setMessage("�����޸�")
				.setPositiveButton("ȷ���ύ", new DialogInterface.OnClickListener() {
					@Override
	    		...
	    		new AlertDialog.Builder(this)
				.setMessage("��Ϣ�Բ��������˳����ܵ�����Ϣ��ʧ")
				.setPositiveButton("ǿ���˳�", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int id) {
						dialog.dismiss(); 
						System.exit(0);
