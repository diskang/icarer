...
import static com.sjtu.icarer.authenticator.IcarerAuthenticatorActivity.PARAM_AUTHTOKEN_TYPE;
...
class IcarerAccountAuthenticator extends AbstractAccountAuthenticator {

    //private static final String DESCRIPTION_CLIENT = "Bootstrap for Android";

    private final Context context;

    public IcarerAccountAuthenticator(final Context context) {
        super(context);
    ...
    public Bundle addAccount(final AccountAuthenticatorResponse response, final String accountType,
        ...
        final Intent intent = new Intent(context, IcarerAuthenticatorActivity.class);
     ...
     * {@link com.sjtu.icarer.authenticator.AccountDataProvider#getAuthKey()}
